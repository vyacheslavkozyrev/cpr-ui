          ...
          <Stack spacing={3}>
            ...
            <Box>
              ...
              <Stack spacing={1}>
                ...
                <Typography variant="body2">
                  <strong>isSystemMode():</strong> {isSystemMode() ? '✅ Yes' : '❌ No'}
                </Typography>
              </Stack>
            </Box>
            ...
            <Box>
              ...
              <Stack spacing={1}>
                ...
                <Typography variant="body1">
                  ...
                  It's optimized for readability and follows Material Design guidelines.
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Body 2: This is secondary body text with a slightly smaller size
                  and secondary color for less prominent content.
                </Typography>
                <Typography variant="caption" color="text.secondary">
                  Caption: This is caption text used for small labels and metadata.
                </Typography>
              </Stack>
            </Box>
