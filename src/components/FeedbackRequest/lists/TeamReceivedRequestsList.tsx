...
import { useManagerTeamReceivedRequests } from '../../../services'
...
/**
 * Team Received Requests List Component
 * Displays paginated list of feedback requests received by team members (read-only manager view)
 * Feature 0004 - US-002B
 */
export const TeamReceivedRequestsList: React.FC = () => {
  ...
  // Fetch team received requests
  const { data, isLoading, error } = useManagerTeamReceivedRequests(params)
  ...
  if (isTrulyEmpty) {
    return <EmptyState type='teamReceived' />
  }
